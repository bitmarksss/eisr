<div id="editInventoryModal" class="fixed inset-0 z-110 flex items-center justify-center p-4 opacity-0 pointer-events-none">
    ...
    <div class="relative bg-white w-full max-w-lg rounded-2xl shadow-2xl border border-gray-100 overflow-hidden transform transition-all z-110 animate-fade-in">
        ...
        <div class="px-6 py-4 bg-brand-green text-white flex justify-between items-center">
            <h3 class="font-bold tracking-wide text-lg">Edit Inventory Item</h3>
        ...
        <form method="POST"
            id="editInventoryForm" class="p-6 space-y-4">
            @csrf
            @method('PUT')
            
            <!-- 1. Name Field -->
            <div>
                <label for="edit-name" class="block text-xs font-bold text-brand-dark uppercase tracking-wider mb-1">Item Title / Descriptor</label>
                <input type="text" id="edit-name" name="name" value="{{ old('name') }}" required placeholder="e.g., Heavy Duty Machine Bolts"
            ...
            <!-- 3. Item Code Field -->
            <div>
                <label for="edit-item_code" class="block text-xs font-bold text-brand-dark uppercase tracking-wider mb-1">Item Code</label>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <!-- 6. Unit Field -->
                    <div>
                    <label for="edit-unit" class="block text-xs font-bold text-brand-dark uppercase tracking-wider mb-1">Unit</label>
