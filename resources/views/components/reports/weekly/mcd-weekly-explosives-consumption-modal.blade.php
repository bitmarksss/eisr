<div id="weeklySummaryModal" class="fixed inset-0 z-110 flex items-center justify-center p-2 sm:p-4 opacity-0 pointer-events-none transition-opacity duration-200">

    <!-- Backdrop -->
    <div id="weeklySummaryBackdrop" class="absolute z-100 inset-0 bg-brand-dark/20 backdrop-blur-xs" onclick="closeWeeklySummaryModal()"></div>
    ...
    <div class="relative bg-white w-full max-w-[98vw] rounded-2xl shadow-2xl border border-gray-200 overflow-hidden transform transition-all z-110 flex flex-col max-h-[92vh]">
        ...
        <div class="px-6 py-4 bg-brand-green text-white flex justify-between items-center shrink-0">
            ...
            <button type="button" onclick="closeWeeklySummaryModal()" class="text-white/70 hover:text-white font-bold text-xl cursor-pointer p-1">✕</button>
        </div>
        ...
        <div class="px-6 py-3 bg-gray-50 border-t border-gray-200 flex justify-between items-center shrink-0">
            <span class="text-xs text-gray-500 font-semibold">Note: Scroll horizontally to view complete inventory metrics across all items.</span>
            <button type="button" onclick="closeWeeklySummaryModal()" class="px-5 py-2 rounded-lg bg-brand-gold hover:bg-brand-gold-hover text-white text-xs font-bold transition cursor-pointer">
                Close
            </button>
        </div>
    </div>
