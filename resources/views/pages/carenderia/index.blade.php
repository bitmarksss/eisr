        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
            ...
            <section class="bg-white p-6 rounded-xl border border-gray-200 shadow-sm space-y-4">
                ...
                <form action="{{ route('carenderia.upload') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
                    @csrf
                    <div class="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center hover:border-amber-500 transition cursor-pointer relative bg-gray-50/50">
                        ...
                        <span class="text-xs text-gray-400 mt-1 block">XLSX, XLS, or CSV format up to 10MB</span>
                    </div>
                    <button type="submit" class="w-full bg-amber-600 hover:bg-amber-700 text-white font-semibold py-2.5 px-4 rounded-xl text-sm transition shadow-sm">
